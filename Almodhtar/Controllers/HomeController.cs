...
using Almodhtar.ViewModels.Home;

namespace Almodhtar.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(string duration,string TypeOfNews)
        {
            ...
            else
            {
                ...
                var homePageViewModel = new HomePageViewModel(news, mostViewedNews,mostTalkNews,mostPopulerNews, videos, countNewsPublished);
